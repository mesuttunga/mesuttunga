...
**CI/CD & Automation:**  
GitHub Actions • Git Workflows • Pipeline Design • Bash Scripting

**Cloud Platforms:**  
AWS (EKS, ECS, RDS, S3, Route53, ALB, CloudWatch, IAM) • Cloudflare

**Linux & Systems:**  
Ubuntu • CentOS • systemd • Process Management • Log Analysis • Security Hardening

**Databases & Networking:**  
MySQL • DNS (Route53, Cloudflare) • SSL/TLS • Firewall Configuration

**Web Stack:**  
Apache • Nginx • PHP • JavaScript • REST APIs
...
💼 [LinkedIn](https://linkedin.com/in/mesuttunga)  
📧 mesut@tunga.com
